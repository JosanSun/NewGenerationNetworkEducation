    ...
    ui(new Ui::PatternTest)
{
    ...
    connect(ui->buttonClose, &QPushButton::clicked, this, &PatternTest::close);                                 // 点击关闭
    connect(ui->buttonMin, &QPushButton::clicked, this, &PatternTest::showMinimized);                           // 点击最小化
